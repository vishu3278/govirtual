    ...
    <div class="wrapper top">
      ...
      <div class="stalls">
        <carousel :autoplay="!projectModal" :autoplayTimeout="5000" :loop="true" :speed="1000" :perPageCustom="[[320, 1], [800, 2]]" :scrollPerPage="false" :paginationEnabled="false" :navigationEnabled="true">
          <slide class="stall animate__animated animate__zoomIn animate__fast" v-for="list in stallList" v-bind:key="list.id" v-bind:data-id="list.id" :data-id="list.id" :data-name="list.name">
            <figure>
              <a :href="list.url">
...
export default {
  data: function() {
    return {
      projectModal: false,
      stallList: [
        { image: 'dist/booth-agrawal.png', id: 2, name: 'Agrawal Construction Co.', offer:{headline:"Exclusive offers and deals", text:"Get exclusive offers and deals on property booking. Contact now for more details "}, url:"https://digimela.com/platform-detail-demo/aggarwal/" },
        { image: 'dist/booth-nirvana.png', id: 1, name: 'Nirwana Greens', offer:{headline:"Exclusive Offers", text:"Now get Exclusive Offers and More. Contact Now for details"}, url:"https://digimela.com/platform-detail-demo/nirvana/"  },
        { image: 'dist/booth-Rajyash.png', id: 7, name: 'Rajyash', offer:{headline:"Gold on Booking", text:"Get 10 Gram Gold on Booking."}, url:"https://digimela.com/platform-detail-demo/rajyash/" },
      ],
      longshot: true
    }
  },
