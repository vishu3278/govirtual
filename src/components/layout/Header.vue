...
<nav class="navbar">
            ...
            <div class="user animate__animated animate__fadeIn animate__delay-1s" v-if="!getUserNameHeader">
                <button class="button red" @click="showModaldata">Get Started</button>
            </div>
            <div class="menu-toggle animate__animated animate__rotateIn " @click="chnageDisplay"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <div class="menu animate__animated animate__fadeInUp" :style="{ display: activedisplay}">
                <ul>
