  ...
  <div>
    ...
    <form @submit.prevent="onRegister">
      <div class="form animate__animated animate__backInUp">
        <div class="input-wrap"> <input type="email" id="email" @blur="$v.email.$touch()" class="input" v-model="email" placeholder="Enter Email.">
        ...
        <div class="input-wrap"> <input type="number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="mobile" @blur="$v.mobile.$touch()" class="input" v-model="mobile" min="0" placeholder="Enter Mobile no.">
        ...
        <div class="input-wrap"><input type="password" id="password" @blur="$v.mobile.$touch()" class="input" v-model="password" placeholder="Enter Password">
